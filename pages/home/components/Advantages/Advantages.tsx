        ...
        <div className={styles.advantageList}>
          <div className={styles.advantage}>
            ...
            <p className={styles.advantageText}>
              We remove the salespeople and offer honest, upfront prices online
            </p>
          </div>
          <div className={styles.advantage}>
            <Image
            ...
            />
            <p className={styles.advantageText}>
              We offer online scheduling so you can book quickly and on your
              schedule
            </p>
          </div>
          <div className={styles.advantage}>
            ...
            />
            <p className={styles.advantageText}>
              We partner with only 5-star rated, licensed, and insured
              installers
            </p>
          </div>
        </div>
