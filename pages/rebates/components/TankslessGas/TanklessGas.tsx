    ...
    <section data-aos="fade" id="tankless" className={styles.sectionContainer}>
      <main className={styles.innerContainer}>
        <div className={styles.headline}>
          ...
          <p>
            Have a tankless water heater you need to replace? We work with top
            of the line gas tankless water heaters.
          </p>
        </div>
        ...
        <div className={styles.footerNote}>
          <p>
            *Prices reflect savings from $800 - $1,000 cash rebates and $300
            federal tax credits.&nbsp;
          </p>
        </div>
      </main>
