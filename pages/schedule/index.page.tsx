...
export default function Home() {
  const calendlyUrl =
    'https://calendly.com/homebreezestagingcalendar/booking-flow-tank-water-heater-installation-dev'
  return (
    <div className="container">
      <Head>
        ...
        <meta
          content="Schedule your water heater installation online to book seamless service with our team of licensed installation experts."
          name="description"
        ></meta>
        <meta
          content="Schedule Your Water Heater Replacement"
          property="og:title"
        ></meta>
        <meta
          content="Schedule your water heater installation online to book seamless service with our team of licensed installation experts."
        ...
        <main className={styles.innerContainer}>
          ...
          <div className={styles.pageContent}>
            <p className={styles.schedulingExplainer}>
              After you book, we&apos;ll call you to confirm installation
              details and answer any questions you might have. Most
              installations last 2-4 hours for tanks & 6-10 hours for tankless.
              <br />
              <br />
